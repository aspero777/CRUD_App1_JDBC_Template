package ru.komarov.springcourse.dao;
...
//Класс общается со списком книг: извлекает книги из списка, находит конкретную книгу по id из списка,
 // в дальнейшем добавляет книгу в список, обновляет или удаляет
@Component
